...
/* 每个通道独立设置比较值 */
#define TIM_SetCompare_RIGHT(Speed)  __HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, (Speed))
#define TIM_SetCompare_LEFT(Speed)   __HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_2, (Speed))
