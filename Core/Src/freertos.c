...
/* Definitions for task_10_ms_low */
osThreadId_t task_10_ms_lowHandle;
const osThreadAttr_t task_10_ms_low_attributes = {
  .name = "task_10_ms_low",
  .stack_size = 256 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of task_10_ms_low */
  task_10_ms_lowHandle = osThreadNew(task_10ms_low_fun, NULL, &task_10_ms_low_attributes);
...
/**
* @brief Function implementing the task_10_ms_low thread.
* @param argument: Not used
* @retval None
*/
